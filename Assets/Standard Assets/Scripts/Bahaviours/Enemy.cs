...
//    float oneBodyPart;
    ...
    void Start()
    {
        ...
        // sets to zero as will be RootMotion
    ...
    void Update()
    {
        ...
        {
            // Detection
            if ((PlayerNoiseNotice() || PlayerVisionNotice()) && PlayerRayNotice())
            {
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        if (isAlive)
        {
            if (other.tag.Equals("PlayerBullet"))
            {
                ...
                // damage
          //      damage = (playerBehaviour.GetCurrentWeaponBehaviour().GetCollisionPoint().y - transform.position.y) / oneBodyPart
    ...
    void ShootToPlayer()
    {
        ...
        if (canShoot && weaponSettings.weapon.CanShoot)
        {
            ...
            weaponSettings.weapon.Fire(previousFirePlayerPosition + new Vector3(0, 1, 0));
        }
